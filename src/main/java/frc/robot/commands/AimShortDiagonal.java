...
public class AimShortDiagonal extends Command {
    ...
    public AimShortDiagonal(SwerveSub swerveSub, ShooterSub shooterSub, ActuatorSub actuatorSub, DoubleSupplier translationSup, DoubleSupplier strafeSup) { //Command constructor
    ...
    public void initialize() {
        ...
        shooterSub.shooterMotorsOnLess();
    }
