...
public class OFSsetPoseAmpNote extends Command {
  
    private final PoseEstimatorSub poseEstimatorSub;

    private final Translation2d blueTranslation = new Translation2d(2.8, 6.95);

    public OFSsetPoseAmpNote(PoseEstimatorSub poseEstimatorSub) { 
