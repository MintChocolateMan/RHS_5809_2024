...
public class OFSsetPoseStageNote extends Command {
  
    private final PoseEstimatorSub poseEstimatorSub;

    private final Translation2d blueTranslation = new Translation2d(2.75, 4.2);

    public OFSsetPoseStageNote(PoseEstimatorSub poseEstimatorSub) { 
