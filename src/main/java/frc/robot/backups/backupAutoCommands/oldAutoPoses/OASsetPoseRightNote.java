...
public class OASsetPoseRightNote extends Command {
  
    private final PoseEstimatorSub poseEstimatorSub;

    private final Translation2d blueTranslation = new Translation2d(8.2, 5.9);

    public OASsetPoseRightNote(PoseEstimatorSub poseEstimatorSub) { 
