...
public class OSsetPoseLeftNote extends Command {
  
    private final PoseEstimatorSub poseEstimatorSub;

    private final Translation2d blueTranslation = new Translation2d(8.2, 2.4);

    public OSsetPoseLeftNote(PoseEstimatorSub poseEstimatorSub) { 
