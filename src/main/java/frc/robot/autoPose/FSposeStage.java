...
public class FSposeStage extends Command {
  
    private final PoseEstimatorSub poseEstimatorSub;

    private final Translation2d blueTranslation = new Translation2d(2.5, 4.3);

    public FSposeStage(PoseEstimatorSub poseEstimatorSub) { 
